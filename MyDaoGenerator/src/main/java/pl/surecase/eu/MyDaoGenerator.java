...
public class MyDaoGenerator {
    ...
    public static void main(String args[]) throws Exception {
        ...
        String outDir="E:/fulicenter/app/src/main/java-gen";
    ...
    private static void addEntity(Schema schema) {
        ...
        entity.addStringProperty("muserName").notNull();//添加String类型的name,不能为空
        entity.addStringProperty("muserPassword");
        entity.addStringProperty("muserNick");
    }
